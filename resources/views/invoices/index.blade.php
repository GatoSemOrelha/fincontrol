...
@section('content')
<div class="topbar">
    <span class="topbar-title">Parcelamentos (RF07)</span>
    @if($user->isAdmin())
        <button class="btn btn-primary" onclick="openModal('modal-installment')"><i class="ti ti-plus"></i>Nova compra parcelada</button>
    @endif
</div>
...
<div class="content">
    <div class="table-wrap">
        <table>
            <thead>
                <tr>
                    <th>Nº Invoice</th><th>Descrição</th><th>Total</th><th>Pago</th>
                    <th>Parcelas restantes</th><th>Status</th><th>Vencimento</th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($inv->remaining_installments > 0)
                                <span class="badge badge-warning">{{ $inv->remaining_installments }} restantes</span>
                            @else
                                <span class="badge badge-success">Todas pagas</span>
                            @endif
                        </td>
                ...
                @empty
                    <tr><td colspan="7" style="color:var(--color-text-tertiary);text-align:center">Nenhum parcelamento encontrado.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
    ...
    <div class="modal">
        ...
        <form method="POST" action="{{ route('invoices.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="description" placeholder="Ex: Notebook Dell Latitude" required>
            </div>
            <div class="form-row-3">
                ...
                <div class="form-group">
                    <label class="form-label">1ª parcela</label>
            ...
            <div class="form-group">
                <label class="form-label">Cartão de crédito (opcional)</label>
            ...
            <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:16px">
                <button type="button" class="btn" onclick="closeModal('modal-installment')">Cancelar</button>
                <button type="submit" class="btn btn-primary">Criar parcelamento</button>
            </div>
        </form>
    </div>
</div>
